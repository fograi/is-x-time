...
test("afternoon in AWS 1999_12_31_23_59", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_US_E_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_US_E_1)).toEqual(
    !isNightInAWS(AWS.AWS_US_E_1) &&
      !isMorningInAWS(AWS.AWS_US_E_1) &&
      !isEveningInAWS(AWS.AWS_US_E_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_US_W_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_US_W_1)).toEqual(
    !isNightInAWS(AWS.AWS_US_W_1) &&
      !isMorningInAWS(AWS.AWS_US_W_1) &&
      !isEveningInAWS(AWS.AWS_US_W_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_US_W_2)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_US_W_2)).toEqual(
    !isNightInAWS(AWS.AWS_US_W_2) &&
      !isMorningInAWS(AWS.AWS_US_W_2) &&
      !isEveningInAWS(AWS.AWS_US_W_2)
  );
  expect(isAfternoonInAWS(AWS.AWS_AF_S_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AF_S_1)).toEqual(
    !isNightInAWS(AWS.AWS_AF_S_1) &&
      !isMorningInAWS(AWS.AWS_AF_S_1) &&
      !isEveningInAWS(AWS.AWS_AF_S_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_E_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AP_E_1)).toEqual(
    !isNightInAWS(AWS.AWS_AP_E_1) &&
      !isMorningInAWS(AWS.AWS_AP_E_1) &&
      !isEveningInAWS(AWS.AWS_AP_E_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_3)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_3)).toEqual(
    !isNightInAWS(AWS.AWS_AP_SE_3) &&
      !isMorningInAWS(AWS.AWS_AP_SE_3) &&
      !isEveningInAWS(AWS.AWS_AP_SE_3)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_S_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AP_S_1)).toEqual(
    !isNightInAWS(AWS.AWS_AP_S_1) &&
      !isMorningInAWS(AWS.AWS_AP_S_1) &&
      !isEveningInAWS(AWS.AWS_AP_S_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_3)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_3)).toEqual(
    !isNightInAWS(AWS.AWS_AP_NE_3) &&
      !isMorningInAWS(AWS.AWS_AP_NE_3) &&
      !isEveningInAWS(AWS.AWS_AP_NE_3)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_2)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_2)).toEqual(
    !isNightInAWS(AWS.AWS_AP_NE_2) &&
      !isMorningInAWS(AWS.AWS_AP_NE_2) &&
      !isEveningInAWS(AWS.AWS_AP_NE_2)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_1)).toEqual(
    !isNightInAWS(AWS.AWS_AP_SE_1) &&
      !isMorningInAWS(AWS.AWS_AP_SE_1) &&
      !isEveningInAWS(AWS.AWS_AP_SE_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_2)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_2)).toEqual(
    !isNightInAWS(AWS.AWS_AP_SE_2) &&
      !isMorningInAWS(AWS.AWS_AP_SE_2) &&
      !isEveningInAWS(AWS.AWS_AP_SE_2)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_1)).toEqual(
    !isNightInAWS(AWS.AWS_AP_NE_1) &&
      !isMorningInAWS(AWS.AWS_AP_NE_1) &&
      !isEveningInAWS(AWS.AWS_AP_NE_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_CA_C_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_CA_C_1)).toEqual(
    !isNightInAWS(AWS.AWS_CA_C_1) &&
      !isMorningInAWS(AWS.AWS_CA_C_1) &&
      !isEveningInAWS(AWS.AWS_CA_C_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_CN_N_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_CN_N_1)).toEqual(
    !isNightInAWS(AWS.AWS_CN_N_1) &&
      !isMorningInAWS(AWS.AWS_CN_N_1) &&
      !isEveningInAWS(AWS.AWS_CN_N_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_CN_NW_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_CN_NW_1)).toEqual(
    !isNightInAWS(AWS.AWS_CN_NW_1) &&
      !isMorningInAWS(AWS.AWS_CN_NW_1) &&
      !isEveningInAWS(AWS.AWS_CN_NW_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_C_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_EU_C_1)).toEqual(
    !isNightInAWS(AWS.AWS_EU_C_1) &&
      !isMorningInAWS(AWS.AWS_EU_C_1) &&
      !isEveningInAWS(AWS.AWS_EU_C_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_W_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_EU_W_1)).toEqual(
    !isNightInAWS(AWS.AWS_EU_W_1) &&
      !isMorningInAWS(AWS.AWS_EU_W_1) &&
      !isEveningInAWS(AWS.AWS_EU_W_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_W_2)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_EU_W_2)).toEqual(
    !isNightInAWS(AWS.AWS_EU_W_2) &&
      !isMorningInAWS(AWS.AWS_EU_W_2) &&
      !isEveningInAWS(AWS.AWS_EU_W_2)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_S_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_EU_S_1)).toEqual(
    !isNightInAWS(AWS.AWS_EU_S_1) &&
      !isMorningInAWS(AWS.AWS_EU_S_1) &&
      !isEveningInAWS(AWS.AWS_EU_S_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_W_3)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_EU_W_3)).toEqual(
    !isNightInAWS(AWS.AWS_EU_W_3) &&
      !isMorningInAWS(AWS.AWS_EU_W_3) &&
      !isEveningInAWS(AWS.AWS_EU_W_3)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_N_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_EU_N_1)).toEqual(
    !isNightInAWS(AWS.AWS_EU_N_1) &&
      !isMorningInAWS(AWS.AWS_EU_N_1) &&
      !isEveningInAWS(AWS.AWS_EU_N_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_ME_S_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_ME_S_1)).toEqual(
    !isNightInAWS(AWS.AWS_ME_S_1) &&
      !isMorningInAWS(AWS.AWS_ME_S_1) &&
      !isEveningInAWS(AWS.AWS_ME_S_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_SA_E_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_SA_E_1)).toEqual(
...
test("afternoon in AWS 2001_01_01_01_02", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_2)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_2)).toEqual(
    !isNightInAWS(AWS.AWS_AP_SE_2) &&
      !isMorningInAWS(AWS.AWS_AP_SE_2) &&
      !isEveningInAWS(AWS.AWS_AP_SE_2)
...
test("afternoon in AWS 2002_02_02_02_04", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_US_W_1)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_US_W_1)).toEqual(
    !isNightInAWS(AWS.AWS_US_W_1) &&
      !isMorningInAWS(AWS.AWS_US_W_1) &&
      !isEveningInAWS(AWS.AWS_US_W_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_US_W_2)).toEqual(false);
  expect(isAfternoonInAWS(AWS.AWS_US_W_2)).toEqual(
    !isNightInAWS(AWS.AWS_US_W_2) &&
      !isMorningInAWS(AWS.AWS_US_W_2) &&
      !isEveningInAWS(AWS.AWS_US_W_2)
...
test("afternoon in AWS 2003_03_03_03_06", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_3)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_3)).toEqual(
    !isNightInAWS(AWS.AWS_AP_NE_3) &&
      !isMorningInAWS(AWS.AWS_AP_NE_3) &&
      !isEveningInAWS(AWS.AWS_AP_NE_3)
  );
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_2)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_2)).toEqual(
    !isNightInAWS(AWS.AWS_AP_NE_2) &&
      !isMorningInAWS(AWS.AWS_AP_NE_2) &&
      !isEveningInAWS(AWS.AWS_AP_NE_2)
  ...
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AP_NE_1)).toEqual(
    !isNightInAWS(AWS.AWS_AP_NE_1) &&
      !isMorningInAWS(AWS.AWS_AP_NE_1) &&
      !isEveningInAWS(AWS.AWS_AP_NE_1)
...
test("afternoon in AWS 2004_04_04_04_08", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_AP_E_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AP_E_1)).toEqual(
    !isNightInAWS(AWS.AWS_AP_E_1) &&
      !isMorningInAWS(AWS.AWS_AP_E_1) &&
      !isEveningInAWS(AWS.AWS_AP_E_1)
  ...
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_1)).toEqual(
    !isNightInAWS(AWS.AWS_AP_SE_1) &&
      !isMorningInAWS(AWS.AWS_AP_SE_1) &&
      !isEveningInAWS(AWS.AWS_AP_SE_1)
  ...
  expect(isAfternoonInAWS(AWS.AWS_CN_N_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_CN_N_1)).toEqual(
    !isNightInAWS(AWS.AWS_CN_N_1) &&
      !isMorningInAWS(AWS.AWS_CN_N_1) &&
      !isEveningInAWS(AWS.AWS_CN_N_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_CN_NW_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_CN_NW_1)).toEqual(
    !isNightInAWS(AWS.AWS_CN_NW_1) &&
      !isMorningInAWS(AWS.AWS_CN_NW_1) &&
      !isEveningInAWS(AWS.AWS_CN_NW_1)
...
test("afternoon in AWS 2005_05_05_05_10", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_3)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AP_SE_3)).toEqual(
    !isNightInAWS(AWS.AWS_AP_SE_3) &&
      !isMorningInAWS(AWS.AWS_AP_SE_3) &&
      !isEveningInAWS(AWS.AWS_AP_SE_3)
...
test("afternoon in AWS 2007_07_07_07_14", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_AP_S_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AP_S_1)).toEqual(
    !isNightInAWS(AWS.AWS_AP_S_1) &&
      !isMorningInAWS(AWS.AWS_AP_S_1) &&
      !isEveningInAWS(AWS.AWS_AP_S_1)
...
test("afternoon in AWS 2009_09_09_09_18", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_ME_S_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_ME_S_1)).toEqual(
    !isNightInAWS(AWS.AWS_ME_S_1) &&
      !isMorningInAWS(AWS.AWS_ME_S_1) &&
      !isEveningInAWS(AWS.AWS_ME_S_1)
...
test("afternoon in AWS 2010_10_10_10_20", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_AF_S_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_AF_S_1)).toEqual(
    !isNightInAWS(AWS.AWS_AF_S_1) &&
      !isMorningInAWS(AWS.AWS_AF_S_1) &&
      !isEveningInAWS(AWS.AWS_AF_S_1)
  ...
  expect(isAfternoonInAWS(AWS.AWS_EU_C_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_EU_C_1)).toEqual(
    !isNightInAWS(AWS.AWS_EU_C_1) &&
      !isMorningInAWS(AWS.AWS_EU_C_1) &&
      !isEveningInAWS(AWS.AWS_EU_C_1)
  ...
  expect(isAfternoonInAWS(AWS.AWS_EU_S_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_EU_S_1)).toEqual(
    !isNightInAWS(AWS.AWS_EU_S_1) &&
      !isMorningInAWS(AWS.AWS_EU_S_1) &&
      !isEveningInAWS(AWS.AWS_EU_S_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_W_3)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_EU_W_3)).toEqual(
    !isNightInAWS(AWS.AWS_EU_W_3) &&
      !isMorningInAWS(AWS.AWS_EU_W_3) &&
      !isEveningInAWS(AWS.AWS_EU_W_3)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_N_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_EU_N_1)).toEqual(
    !isNightInAWS(AWS.AWS_EU_N_1) &&
      !isMorningInAWS(AWS.AWS_EU_N_1) &&
      !isEveningInAWS(AWS.AWS_EU_N_1)
...
test("afternoon in AWS 2012_12_12_12_24", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_EU_W_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_EU_W_1)).toEqual(
    !isNightInAWS(AWS.AWS_EU_W_1) &&
      !isMorningInAWS(AWS.AWS_EU_W_1) &&
      !isEveningInAWS(AWS.AWS_EU_W_1)
  );
  expect(isAfternoonInAWS(AWS.AWS_EU_W_2)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_EU_W_2)).toEqual(
    !isNightInAWS(AWS.AWS_EU_W_2) &&
      !isMorningInAWS(AWS.AWS_EU_W_2) &&
      !isEveningInAWS(AWS.AWS_EU_W_2)
...
test("afternoon in AWS 2015_05_15_15_30", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_SA_E_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_SA_E_1)).toEqual(
    !isNightInAWS(AWS.AWS_SA_E_1) &&
      !isMorningInAWS(AWS.AWS_SA_E_1) &&
      !isEveningInAWS(AWS.AWS_SA_E_1)
...
test("afternoon in AWS 2016_06_16_16_32", () => {
  ...
  expect(isAfternoonInAWS(AWS.AWS_US_E_2)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_US_E_2)).toEqual(
    !isNightInAWS(AWS.AWS_US_E_2) &&
      !isMorningInAWS(AWS.AWS_US_E_2) &&
      !isEveningInAWS(AWS.AWS_US_E_2)
  );
  expect(isAfternoonInAWS(AWS.AWS_US_E_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_US_E_1)).toEqual(
    !isNightInAWS(AWS.AWS_US_E_1) &&
      !isMorningInAWS(AWS.AWS_US_E_1) &&
      !isEveningInAWS(AWS.AWS_US_E_1)
  ...
  expect(isAfternoonInAWS(AWS.AWS_CA_C_1)).toEqual(true);
  expect(isAfternoonInAWS(AWS.AWS_CA_C_1)).toEqual(
    !isNightInAWS(AWS.AWS_CA_C_1) &&
      !isMorningInAWS(AWS.AWS_CA_C_1) &&
      !isEveningInAWS(AWS.AWS_CA_C_1)
