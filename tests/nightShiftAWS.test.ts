...
test("night shift in AWS 1999_12_31_23_59", () => {
  jest.setSystemTime(new Date(DATES.DATE_1999_12_31_23_59));
  expect(isNightShiftInAWS(AWS.AWS_US_E_2)).toEqual(false);
  expect(isNightShiftInAWS(AWS.AWS_US_E_2)).toEqual(
    !isDayShiftInAWS(AWS.AWS_US_E_2) && !isEveningShiftInAWS(AWS.AWS_US_E_2)
  );
  expect(isNightShiftInAWS(AWS.AWS_US_E_1)).toEqual(false);
  ...
  expect(isNightShiftInAWS(AWS.AWS_AF_S_1)).toEqual(true);
  ...
  expect(isNightShiftInAWS(AWS.AWS_CA_C_1)).toEqual(false);
...
test("night shift in AWS 2000_01_01_00_00", () => {
...
test("night shift in AWS 2001_01_01_01_02", () => {
...
test("night shift in AWS 2002_02_02_02_04", () => {
...
test("night shift in AWS 2003_03_03_03_06", () => {
...
test("night shift in AWS 2004_04_04_04_08", () => {
...
test("night shift in AWS 2005_05_05_05_10", () => {
  jest.setSystemTime(new Date(DATES.DATE_2005_05_05_05_10));
  expect(isNightShiftInAWS(AWS.AWS_US_E_2)).toEqual(true);
  expect(isNightShiftInAWS(AWS.AWS_US_E_2)).toEqual(
    !isDayShiftInAWS(AWS.AWS_US_E_2) && !isEveningShiftInAWS(AWS.AWS_US_E_2)
  );
  expect(isNightShiftInAWS(AWS.AWS_US_E_1)).toEqual(true);
  expect(isNightShiftInAWS(AWS.AWS_US_E_1)).toEqual(
    !isDayShiftInAWS(AWS.AWS_US_E_1) && !isEveningShiftInAWS(AWS.AWS_US_E_1)
  );
  expect(isNightShiftInAWS(AWS.AWS_US_W_1)).toEqual(false);
  ...
  expect(isNightShiftInAWS(AWS.AWS_AF_S_1)).toEqual(false);
  expect(isNightShiftInAWS(AWS.AWS_AF_S_1)).toEqual(
    !isDayShiftInAWS(AWS.AWS_AF_S_1) && !isEveningShiftInAWS(AWS.AWS_AF_S_1)
  );
  expect(isNightShiftInAWS(AWS.AWS_AP_E_1)).toEqual(false);
  ...
  expect(isNightShiftInAWS(AWS.AWS_CA_C_1)).toEqual(true);
  expect(isNightShiftInAWS(AWS.AWS_CA_C_1)).toEqual(
    !isDayShiftInAWS(AWS.AWS_CA_C_1) && !isEveningShiftInAWS(AWS.AWS_CA_C_1)
  );
  expect(isNightShiftInAWS(AWS.AWS_CN_N_1)).toEqual(false);
...
test("night shift in AWS 2006_06_06_06_12", () => {
...
test("night shift in AWS 2007_07_07_07_14", () => {
...
test("night shift in AWS 2008_08_08_08_16", () => {
...
test("night shift in AWS 2009_09_09_09_18", () => {
...
test("night shift in AWS 2010_10_10_10_20", () => {
...
test("night shift in AWS 2011_11_11_11_22", () => {
...
test("night shift in AWS 2012_12_12_12_24", () => {
...
test("night shift in AWS 2013_03_13_13_26", () => {
...
test("night shift in AWS 2014_04_14_14_28", () => {
...
test("night shift in AWS 2015_05_15_15_30", () => {
...
test("night shift in AWS 2016_06_16_16_32", () => {
...
test("night shift in AWS 2017_07_17_17_34", () => {
...
test("night shift in AWS 2018_08_18_18_36", () => {
...
test("night shift in AWS 2019_09_19_19_38", () => {
...
test("night shift in AWS 2020_02_20_20_40", () => {
...
test("night shift in AWS 2021_01_21_21_42", () => {
...
test("night shift in AWS 2022_02_22_22_44", () => {
...
test("night shift in AWS 2023_03_23_23_46", () => {
...
test("night shift in AWS 2024_04_24_00_48", () => {
